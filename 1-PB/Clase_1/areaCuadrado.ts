...
function areacuadrado(base: number, altura: number) {
...
function main() {
    ...
    const base: any = rl.question("Ingrese la base del cuadrado (cm): ");
    const altura: any = rl.question("Ingrese la altura del cuadrado (cm): ");
    ...
    const next = rl.question("Calcular nuevamente? (si o no): ");
