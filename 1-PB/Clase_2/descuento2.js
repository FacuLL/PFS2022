...
var precio = rl.questionFloat("Ingrese el precio del producto: ");
var cantidad = rl.questionFloat("Ingrese la cantidad del producto: ");
// Si el precio es mayor a 1000, se imprime el precio del producto con el descuento aplicado
if (precio * cantidad > 1000) {
    var descuento = precio * cantidad * 0.1;
